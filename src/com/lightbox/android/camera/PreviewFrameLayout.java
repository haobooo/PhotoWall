...
public class PreviewFrameLayout extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {    	
        int frameWidth = mwidth;
        int frameHeight = mheight;
...
//        int vSpace = ((b - t) - frameHeight) / 2;
        ...
        int hSpace = (mwidth - frameWidth )/2;
        int vSpace = (mheight - frameHeight)/2;
        mFrame.measure(
...
//        mFrame.layout(l + hSpace, t + vSpace, r - hSpace, b - vSpace);
        mFrame.layout(0+hSpace, 0+vSpace, frameWidth+hSpace,frameHeight+vSpace);
