...
public class ArchievementGridView extends BaseAdapter implements OnClickListener{
    ...
    public  ArchievementGridView(Context context,List<AchmInfo> mList,int resource) {
    ...
    public View getView(int index, View convertView, ViewGroup parent) {
        ...
        if(PhotoWallApplication.getPhotoWallApplication().isLeadingMode() && index==0)
        {
        	convertView.setBackgroundResource(R.drawable.guide_red);
        	if(guideLocationListener!=null)
        	{
        		guideLocationListener.onGuideLocate(convertView);
        	}
        }
        return convertView;
    }
    ...
    // for guide
    private static GuideLocationListener guideLocationListener;
    
    public interface GuideLocationListener
    {
    	public void onGuideLocate(View view);
    }
    
    public static void setGuideListener(GuideLocationListener listener)
    {
    	guideLocationListener = listener;
    }
}