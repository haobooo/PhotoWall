package com.photowall.widget.staggedGridView;
 ...
 */
public class ScrollStaggeredGridView extends ViewGroup {
    ...
    public ScrollStaggeredGridView(Context context) {
        this(context, null);
    }

    public ScrollStaggeredGridView(Context context, AttributeSet attrs) {
...
//                nextCol = rec.column;
    ...
    public interface OnItemClickListener {
         ...
         */
        void onItemClick(ScrollStaggeredGridView parent, View view, int position, long id);
    }
    ...
    public interface OnItemLongClickListener {
         ...
         */
        boolean onItemLongClick(ScrollStaggeredGridView parent, View view, int position, long id);
    }
